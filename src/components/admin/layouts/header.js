        ...
        <div className="header">
				...
				<ul className="nav user-menu">
						...
						<div className="dropdown-menu">
							<div className="noti-content">
								<div>
									...
									<a className="dropdown-item" href="javascript:;"><i className="flag flag-cn me-2"></i>Turkce</a>
								</div>
							</div>
						</div>
					</li>
					...
					<li className="nav-item dropdown noti-dropdown me-2">
						<a href="#" className="dropdown-toggle nav-link header-nav-list" data-bs-toggle="dropdown">
							<img src="admin/assets/img/icons/header-icon-05.svg" alt />
						</a>
								...
								<ul className="notification-list">
										...
										<a href="#">
											<div className="media d-flex">
												<span className="avatar avatar-sm flex-shrink-0">
													<img className="avatar-img rounded-circle" alt="User Image" src="admin/assets/img/profiles/avatar-02.jpg" />
												</span>
									...
									<li className="notification-message">
										<a href="#">
											<div className="media d-flex">
												<span className="avatar avatar-sm flex-shrink-0">
													<img className="avatar-img rounded-circle" alt="User Image" src="admin/assets/img/profiles/avatar-11.jpg" />
												</span>
												<div className="media-body flex-grow-1">
									...
									<li className="notification-message">
										<a href="#">
											<div className="media d-flex">
												<span className="avatar avatar-sm flex-shrink-0">
													<img className="avatar-img rounded-circle" alt="User Image" src="admin/assets/img/profiles/avatar-17.jpg" />
												</span>
												<div className="media-body flex-grow-1">
									...
									<li className="notification-message">
										<a href="#">
											<div className="media d-flex">
												<span className="avatar avatar-sm flex-shrink-0">
													<img className="avatar-img rounded-circle" alt="User Image" src="admin/assets/img/profiles/avatar-13.jpg" />
												</span>
												<div className="media-body flex-grow-1">
					...
					<li className="nav-item dropdown has-arrow new-user-menus">
						<a href="#" className="dropdown-toggle nav-link" data-bs-toggle="dropdown">
							<span className="user-img">
								<img className="rounded-circle" src="admin/assets/img/profiles/avatar-01.jpg" width="31" alt="Ryan Taylor" />
