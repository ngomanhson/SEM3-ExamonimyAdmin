    ...
    useEffect(() => {
        ...
        $menuItems.each(function () {
            ...
            if (location.pathname === href) {
                $(this).parents("li.submenu").addClass("active");
            }
        });
        return () => {
                            ...
                            <ul>
                                ...
                                <li className="submenu">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="add-subject.html">
                                                Subject Add
                                            </a>
                                        </li>
                                        <li>
                                            <a href="edit-subject.html">
                                                Subject Edit
                                            </a>
                                        </li>
                                    </ul>
                                ...
                                <li className="submenu">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <a href="add-fees-collection.html">
                                                Add Fees
                                            </a>
                                        </li>
                                        <li>
