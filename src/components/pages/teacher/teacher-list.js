    ...
    const handleDeleteTeacher = async (id) => {
        ...
        if (confirm) {
            try {
                ...
                setTeacher((prevTeacher) => prevTeacher.filter((teacher) => teacher.id !== id));
            } catch (error) {
                                        ...
                                        <div className="page-header">
                                            <div className="row align-items-center">
                                                ...
                                                <div className="col-auto text-end float-end ms-auto download-grp">
                                                    ...
                                                    <a href="teachers-grid.html" className="btn btn-outline-gray me-2">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td className="text-end">
                                                                    <div className="actions">
                                                                        ...
                                                                        <NavLink to={`/teacher-edit/${item.id}`} className="btn btn-sm bg-danger-light">
                                                                            <i className="feather-edit"></i>
                                                                        </NavLink>
                                                                        <NavLink onClick={() => handleDeleteTeacher(item.id)} className="btn btn-sm bg-danger-light">
