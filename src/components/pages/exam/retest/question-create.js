...
function Question_Create({ onQuestionAdded, onQuestionRemoved }) {
    ...
    const handleAddQuestion = () => {
        ...
        if (isValid) {
            ...
            if (questionCount === 15) {
                const addQuestionButton = document.querySelector(".btn.btn-primary.float-sm-end.m-l-10");
            ...
            <div className="col-xl-6">
                <div className="card bg-white">
                    <div class="card-header">
                        <h5 class="card-title">
                            Test Question
                            <button type="button" className="btn btn-primary float-sm-end m-l-10" data-bs-toggle="modal" data-bs-target="#scrollable-modal">
                                Add New Question
                            </button>
                        </h5>
                        <div className="modal fade" id="scrollable-modal" tabindex="-1" role="dialog" aria-labelledby="scrollableModalTitle" aria-hidden="true" ref={questionModalRef}>
                                ...
                                <div className="modal-content">
                                    ...
                                    <div className="modal-body">
                                        <div className="form-group">
                                            ...
                                            <input type="text" ref={questionTitleRef} className="form-control" />
                                        ...
                                        <div className="form-group">
                                            ...
                                            <input type="text" ref={answerARef} className="form-control" />
                                            {questionErrors.answerA && <div className="text-danger">{questionErrors.answerA}</div>}
                                        </div>
                                        <div className="form-group">
                                            <label>Choice B</label>
                                            <input type="text" ref={answerBRef} className="form-control" />
                                            {questionErrors.answerB && <div className="text-danger">{questionErrors.answerB}</div>}
                                        </div>
                                        <div className="form-group">
                                            <label>Choice C</label>
                                            <input type="text" ref={answerCRef} className="form-control" />
                                            {questionErrors.answerC && <div className="text-danger">{questionErrors.answerC}</div>}
                                        </div>
                                        <div className="form-group">
                                            <label>Choice D</label>
                                            <input type="text" ref={answerDRef} className="form-control" />
                                            {questionErrors.answerD && <div className="text-danger">{questionErrors.answerD}</div>}
                                        </div>
                                        <div className="form-group">
                                            <label>Correct Answer</label>
                                            <select className="form-control" ref={correctAnswerRef}>
                                            ...
                                            {questionErrors.correctAnswer && <div className="text-danger">{questionErrors.correctAnswer}</div>}
                                        </div>
                                        <div className="form-group">
                                            <label>Level of difficult</label>
                                            <select className="form-control" ref={levelRef}>
                                                <option value="">Select level question...</option>
                                                {easyCount < 6 && <option value="1">Easy</option>}
                                                {mediumCount < 5 && <option value="2">Medium</option>}
                                                {difficultCount < 5 && <option value="3">Difficult</option>}
                                            </select>
                                    ...
                                    <div className="modal-footer">
                                        ...
                                        <button type="button" className="btn btn-primary" onClick={handleAddQuestion} data-bs-dismiss={isQuestionAdded ? "modal" : ""}>
                                            Add Question
                                        </button>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-10">
                                <h5>
                                    ...
                                    >
                                        ({easyCount}/6 easy, {mediumCount}/5 medium, {difficultCount}/5 difficult)
                                    </span>
                                </h5>
                            </div>
                            <div class="col-md-2">
                                            ...
                                            <div key={index} className="row">
                                                <div className="col-md-10">
                                                    <div className="invoice-terms">
                                                        <h6>
                                                            {index + 1}.<span>{question.title}</span>{" "}
                                                            <span
                                                                style={{
                                                                    fontSize: "15px",
                                                                    color: "#8F9BBA",
                                                            ...
                                                            >
                                                                ({question.level === "1" ? "Easy" : question.level === "2" ? "Medium" : "Difficult"}, {question.score} point)
                                                            </span>
                                                        </h6>
                                                        {question.answers.map((answer, i) => (
                                                            <p key={i} className={`mb-1 ${answer.status === 1 ? "text-primary" : ""}`}>
                                                                {String.fromCharCode(65 + i)}-<span>{answer.content}</span>
                                                                {answer.status === 1 && <i className="fa fa-check"></i>}
                                                            </p>
                                                        ))}
                                                    </div>
                                                </div>
